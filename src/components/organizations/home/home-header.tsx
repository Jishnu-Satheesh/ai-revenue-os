...
/**
 * Identity block: the one `h1` (the saved organization name), the eligible
 * logo or a name-only layout, the saved description or nothing invented, the
 * context row (status, locations, timezone · currency) and a divider. Primary
 * actions sit right-aligned: Manage is a real anchor to the management
 * surface Task 6 mounts below, and New campaign navigates to the creation
 * route only when the view permits it — viewers see neither.
 */
