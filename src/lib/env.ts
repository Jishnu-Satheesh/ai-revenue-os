...
const serverEnvSchema = z.object({
  ...
  GROWTH_INTELLIGENCE_MARKET_ORGANIZATION_IDS: optionalNonEmptyString,
  GROWTH_INTELLIGENCE_SYNTHESIS_ORGANIZATION_IDS: optionalNonEmptyString,
  ...
  RECOMMENDATION_JUDGE_MODEL: optionalNonEmptyString,
...
const parsedEnv = serverEnvSchema.safeParse({
  ...
  GOVERNED_REPORT_PROJECTION_ORGANIZATION_IDS:
    process.env.GOVERNED_REPORT_PROJECTION_ORGANIZATION_IDS,
  ...
  GOVERNED_CHANNEL_ANALYSIS_ORGANIZATION_IDS:
    process.env.GOVERNED_CHANNEL_ANALYSIS_ORGANIZATION_IDS,
  GROWTH_INTELLIGENCE_MARKET_ORGANIZATION_IDS:
    process.env.GROWTH_INTELLIGENCE_MARKET_ORGANIZATION_IDS,
  GROWTH_INTELLIGENCE_SYNTHESIS_ORGANIZATION_IDS:
    process.env.GROWTH_INTELLIGENCE_SYNTHESIS_ORGANIZATION_IDS,
  GROWTH_INTELLIGENCE_TRIAGE_ORGANIZATION_IDS:
    process.env.GROWTH_INTELLIGENCE_TRIAGE_ORGANIZATION_IDS,
  ...
  RECOMMENDATION_JUDGE_MODEL: process.env.RECOMMENDATION_JUDGE_MODEL,
