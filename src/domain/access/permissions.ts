...
export const permissionDescriptions: Readonly<Record<Permission, string>> = {
  ...
  "channel.read": "See organization-owned channels and their mappings.",
  "channel.manage": "Create, rename, categorize, archive, and restore channels.",
  "channel.map_branch": "Map channel aliases and branch applicability.",
  "report.read": "See governed report package status and bounded evidence.",
  "report.upload": "Upload a governed report package to private storage.",
  "report.retry": "Retry a failed governed report package.",
