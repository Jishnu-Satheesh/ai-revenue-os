...
values ('acc00000-0000-4000-8000-a2463172fe67'::uuid, 'Fixture agency', 'fixture-agency-campaign-tool-gateway-test', '7a000000-0000-4000-8000-000000000001'::uuid);
...
values (
  ...
  '7a000000-0000-4000-8000-000000000001'::uuid,
    'acc00000-0000-4000-8000-a2463172fe67'::uuid);
