...
values ('acc00000-0000-4000-8000-74f57067f280'::uuid, 'Fixture agency', 'fixture-agency-metric-registry-test', '4b2f0c1f-1760-4b25-8b15-100000000001'::uuid);
...
values
  (
    ...
    'acc00000-0000-4000-8000-74f57067f280'::uuid),
  (
