-- Unqualify GREATEST inside the gateway claim, a third time.
--
...
-- the claim raises the moment a spend ceiling is evaluated. Unqualified is
-- correct and not a search_path risk (parser resolves it before schema
-- lookup). Fixed twice before (20260815204500, 20260822094000); the
-- launch-gate re-creation copied an old body and reintroduced it.
-- Single-line change; whole body repeated for CREATE OR REPLACE.
