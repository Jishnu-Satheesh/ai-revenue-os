...
- Atomic reconnect/grant/mapping/disconnect methods deliberately cannot execute until the database transaction/RPC port is backed by a migration. This is fail-closed by design.
